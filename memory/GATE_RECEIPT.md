...
- **Waktu:** 2026-08-24 11:13:06
- **Mode:** `full`  ·  **Durasi total:** 393s  ·  **Pekerja statik:** 1
...
| verify_data_integrity (229 invarian domain/GL/alert/ledger/config/relasi/pembayaran/selisih/bank/kasus/kontrabon/antar-entitas) | PASS (5s) |
...
| POC FASE E-0 (bukti-merah L1–L21: notifikasi·denda·audit·lot·AR·transfer·dokumen·pratinjau) | PASS (5s) |
...
| POC FASE E-5 (papan stok agregat · pegging · mutasi lintas-PT nama singkat · kartu riwayat) | PASS (3s) |
