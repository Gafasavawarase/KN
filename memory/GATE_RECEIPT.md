...
- **Waktu:** 2026-08-24 10:17:06
- **Mode:** `full`  ·  **Durasi total:** 419s  ·  **Pekerja statik:** 1
...
| config_wiring SELF-TEST (bukti-merah guardrail) | PASS (15s) |
...
| guard:nonfinancial_sweep (INV-ENTITY-01+, IDOR non-finansial) | PASS (3s) |
...
| POC Pengingat Antrean Persetujuan (umur tunggu · eskalasi · idempotent · ambang pemilik) | PASS (3s) |
...
| guard:state_machine (INV-STATE-01, transisi SO) | PASS (2s) |
| guard:line_scope SELF-TEST (bukti-merah pagar lini, 15 kasus dua arah) | PASS (0s) |
| guard:line_scope (INV-LINE-01/02, kode dikenal · turunan jujur · snapshot lengkap) | PASS (2s) |
...
| guard:uom_vocab (INV-UOM-02, satuan dokumen ⊆ master uoms · alias tak kembar · pemilih satuan dari master) | PASS (3s) |
...
| guard:doc_origin (INV-ORIG-01, satu definisi asal PO · sales dirunut bukan diketik · refs dua arah) | PASS (2s) |
...
| POC FASE P (papan PO per lini: tahap dari master · sales dirunut · inspect turunan · terima dihitung · nol residu) | PASS (12s) |
...
| POC FASE G-2 (rencana pembayaran & denda) | PASS (15s) |
| POC FASE G-3 (selisih pembayaran lebih/kurang bayar) | PASS (16s) |
| POC FASE F-1 (penerimaan satuan supplier) | PASS (4s) |
| POC FASE F (R&D · labdip/proofing · lifecycle produk) | PASS (17s) |
